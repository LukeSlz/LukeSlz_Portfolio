        ...
        <div className="text-zone">
          ...
          <div className="cvs-container">
            <div className="each-cv-cont">
              <a className='to-CV' href={process.env.PUBLIC_URL + '/assets/docs/CV_Lucas_Salazar.pdf'}>
                <FontAwesomeIcon icon={faFilePdf} className='CV-icon' />
                <h3>English</h3>
              </a>
            </div>
            <div className="each-cv-cont">
              <a className='to-CV' href={process.env.PUBLIC_URL + '/assets/docs/CV_Lucas_Salazar_ESP.pdf'}>
                <FontAwesomeIcon icon={faFilePdf} className='CV-icon' />
                <h3>Spanish</h3>
              </a>
            </div>
